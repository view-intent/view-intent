...
(function (DataFetch) {
    ...
    function origin() {
        return config_1.Config.options.apiOrigin;
    }
    ...
    function get(url, data) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        u = new utility_collection_1.Url(url);
                        u.setQueries(data);
                                    ...
                                    if (response.data.intent !== undefined && response.data.intent !== null) {
                                        ...
                                        if (!response.urlRedirected.includes("p=")) {
                                            if (!viewIntentedPushed || response.redirected) {
                                                nav_1.Nav.intentView(data_1.intent, response.urlRedirected);
                                            }
                                            if (!utility_collection_1.Is.empty(data_1.intent.redirect)) {
