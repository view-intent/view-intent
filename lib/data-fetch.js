                            ...
                            if (response.data.intent !== undefined && response.data.intent !== null) {
                                ...
                                if (!response.urlRedirected.includes("p=")) {
                                    if (!viewIntentedPushed || response.redirected) {
                                        // const newUrlRedirected = new Url(response.urlRedirected!);
                                        // newUrlRedirected.setOrigin(window.location.origin, false);
                                        // response.urlRedirected! = newUrlRedirected.toString();
                                        // if (data.intent!.redirect !== undefined && data.intent!.redirect !== null) {
                                        // 	const newIntentRedirect = new Url(data.intent!.redirect!);
                                        // 	newIntentRedirect.setOrigin(window.location.origin);
                                        // 	data.intent!.redirect = newIntentRedirect.toString();
                                        // }
