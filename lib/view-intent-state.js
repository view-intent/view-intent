...
var ViewState = /** @class */ (function (_super) {
    ...
    function ViewState(intent, root) {
        ...
        if (utility_collection_1.Is.empty(intent.instanceId) || intent.instanceId === "new" || intent.instanceId === "last") {
            _this.instanceId = uniqid_1.process();
        }
        else {
            _this.instanceId = intent.instanceId.toString();
        }
        _this.viewState = intent.viewState;
        _this.viewTypeInfo = view_type_store_1.ViewTypeStore.getViewTypeInfo(_this.areaName, _this.viewType);
    ...
    ViewState.prototype.notify = function () {
        return this.notify();
    };
