...
var ViewFrame = /** @class */ (function (_super) {
    ...
    ViewFrame.prototype.render = function () {
        ...
        return React.createElement(ReactCSSTransitionGroup, { transitionName: stack, transitionAppear: true, transitionLeave: false, transitionEnter: true, component: "div", id: this.props.id, className: (this.props.className !== undefined && this.props.className !== null) ? "view-intent-frame " + this.props.className : "view-intent-frame", transitionEnterTimeout: 300, transitionLeaveTimeout: 300, transitionAppearTimeout: 300 }, this.renderViewList());
    };
    return ViewFrame;
}(React.Component));
export { ViewFrame };
