...
import { observe } from "view-intent-mobx";
    ...
    renderViewList() {
        ...
        const r = ViewIntentState.Instance.getViewStateListByFrameId(stateId)
            ...
            if (viewState.isVisible) {
                return React.createElement(ViewRenderComponent, { viewState: viewState, key: viewState.areaName + "." + viewState.viewType + ":" + viewState.instanceId });
            }
