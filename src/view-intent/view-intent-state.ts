import { action, computed, extendShallowObservable, observable, ObservableMap, toJS } from "../mobx/main"; // "view-intent-mobx";
...
export class ViewIntentState {
  ...
  @action public processPopIntent(navState: INavState) {
